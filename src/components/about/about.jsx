  ...
  return(
      <section id='about'>
        ...
        <div className='aboutMessage'>
          <p>
            I am passionate about web development with a balance focus on both frontend and backend development.
          </p>
          <p>
          ...
          <p>
            One last thing, I'm available for <strong><em>freelance</em></strong> work, so feel free to reach out to me and say hello!
          </p>
        </div>
      </section>
    )
